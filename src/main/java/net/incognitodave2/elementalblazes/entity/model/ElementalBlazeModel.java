package net.incognitodave2.elementalblazes.entity.model;
...
@OnlyIn(Dist.CLIENT)
public class ElementalBlazeModel<T extends Entity> extends SegmentedModel<T> {
    private final ModelRenderer[] blazeSticks;
    private final ModelRenderer blazeHead = new ModelRenderer(this, 0, 6);
    private final ImmutableList<ModelRenderer> field_228242_f_;

    public ElementalBlazeModel() {
