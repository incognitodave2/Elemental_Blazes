...
public class ObsidianBlazeEntityTier5 extends BlazeEntity {
    ...
    public void livingTick() {
        ...
        if (!this.world.isRemote && this.isAlive() && --this.timeUntilNextRod <= 0) {
            ...
            this.entityDropItem(Items.OBSIDIAN);
            this.entityDropItem(Items.OBSIDIAN);
            this.entityDropItem(Items.OBSIDIAN);
            this.entityDropItem(Items.OBSIDIAN);
            this.entityDropItem(Items.OBSIDIAN);
    ...
    public ObsidianBlazeEntityTier5(EntityType<? extends BlazeEntity> type, World world) {
        super(type, world);
    }
