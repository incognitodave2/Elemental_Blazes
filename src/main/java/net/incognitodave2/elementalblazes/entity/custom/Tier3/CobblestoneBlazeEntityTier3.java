package net.incognitodave2.elementalblazes.entity.custom.Tier3;
...
public class CobblestoneBlazeEntityTier3 extends BlazeEntity {
    ...
    public void livingTick() {
        ...
        if (!this.world.isRemote && this.isAlive() && --this.timeUntilNextRod <= 0) {
            ...
            this.entityDropItem(Items.COBBLESTONE);
            this.entityDropItem(Items.COBBLESTONE);
            this.entityDropItem(Items.COBBLESTONE);
            this.timeUntilNextRod = 100;
        }
    }
    public CobblestoneBlazeEntityTier3(EntityType<? extends BlazeEntity> type, World world) {
        super(type, world);
    }
