package net.incognitodave2.elementalblazes.entity.custom.Tier4;
...
public class CobblestoneBlazeEntityTier4 extends BlazeEntity {
    ...
    public CobblestoneBlazeEntityTier4(EntityType<? extends BlazeEntity> type, World world) {
        super(type, world);
    }
