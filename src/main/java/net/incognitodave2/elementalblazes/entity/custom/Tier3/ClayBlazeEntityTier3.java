...
public class ClayBlazeEntityTier3 extends BlazeEntity {
    ...
    public void livingTick() {
        ...
        if (!this.world.isRemote && this.isAlive() && --this.timeUntilNextRod <= 0) {
            ...
            this.entityDropItem(Items.CLAY);
            this.entityDropItem(Items.CLAY);
            this.entityDropItem(Items.CLAY);
            this.timeUntilNextRod = 100;
        }
    }
    public ClayBlazeEntityTier3(EntityType<? extends BlazeEntity> type, World world) {
        super(type, world);
    }
