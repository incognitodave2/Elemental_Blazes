package net.incognitodave2.elementalblazes.entity.custom.Tier5;
...
public class CobblestoneBlazeEntityTier5 extends BlazeEntity {
    ...
    public CobblestoneBlazeEntityTier5(EntityType<? extends BlazeEntity> type, World world) {
        super(type, world);
    }
