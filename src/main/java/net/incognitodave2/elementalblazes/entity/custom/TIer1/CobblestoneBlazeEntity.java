package net.incognitodave2.elementalblazes.entity.custom.TIer1;
...
public class CobblestoneBlazeEntity extends BlazeEntity {
    ...
    public CobblestoneBlazeEntity(EntityType<? extends BlazeEntity> type, World world) {
        super(type, world);
    }
