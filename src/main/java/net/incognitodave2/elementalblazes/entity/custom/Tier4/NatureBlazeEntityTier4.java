...
public class NatureBlazeEntityTier4 extends BlazeEntity {
    ...
    public void livingTick() {
        ...
        if (!this.world.isRemote && this.isAlive() && --this.timeUntilNextRod <= 0) {
            ...
            this.entityDropItem(ModItems.NATURE_ROD.get());
            this.entityDropItem(ModItems.NATURE_ROD.get());
            this.entityDropItem(ModItems.NATURE_ROD.get());
            this.entityDropItem(ModItems.NATURE_ROD.get());
    ...
    public NatureBlazeEntityTier4(EntityType<? extends BlazeEntity> type, World world) {
        super(type, world);
    }
