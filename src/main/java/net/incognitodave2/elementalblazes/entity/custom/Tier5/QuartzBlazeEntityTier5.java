...
public class QuartzBlazeEntityTier5 extends BlazeEntity {
    ...
    public void livingTick() {
        ...
        if (!this.world.isRemote && this.isAlive() && --this.timeUntilNextRod <= 0) {
            ...
            this.entityDropItem(Items.QUARTZ);
            this.entityDropItem(Items.QUARTZ);
            this.entityDropItem(Items.QUARTZ);
            this.entityDropItem(Items.QUARTZ);
            this.entityDropItem(Items.QUARTZ);
    ...
    public QuartzBlazeEntityTier5(EntityType<? extends BlazeEntity> type, World world) {
        super(type, world);
    }
